...
interface InvestigatingAdsTabProps {
...
export const InvestigatingAdsTab: React.FC<InvestigatingAdsTabProps> = ({
  postReports,
  onDismissAllReports,
  handleAdAction,
  onRefresh,
              ...
              return (
                <React.Fragment key={item.postId}>
                  <tr className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    {/* Reports */}
                    <td className="px-4 py-3">
                      <span className="inline-flex items-center px-2.5 py-1 text-sm font-medium text-blue-800 bg-blue-100 dark:bg-blue-900/20 dark:text-blue-300 rounded-full">
