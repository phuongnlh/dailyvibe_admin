...
import type { PostReport } from "../../api/post";

interface ExpandedPostReportsProps {
  reports: PostReport[];
...
const ExpandedPostReports: React.FC<ExpandedPostReportsProps> = ({
  reports,
  reportTypeCount,
  postId,
  postAuthorId,
...
export default ExpandedPostReports;