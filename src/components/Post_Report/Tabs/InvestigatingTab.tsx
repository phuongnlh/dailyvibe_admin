...
interface InvestigatingTabProps {
...
export const InvestigatingTab: React.FC<InvestigatingTabProps> = ({
  postReports,
  onDismissAllReports,
  handlePostAction,
  onRefresh,
            ...
            {postReports.map((item) => (
              <React.Fragment key={item.postId}>
                <tr className="hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="inline-flex items-center px-3 py-1 text-sm font-medium text-blue-800 bg-blue-100 dark:bg-blue-900/20 dark:text-blue-300 rounded-full">
